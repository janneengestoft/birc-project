...
run_name = "female_chr7_unlinked"
cp_dir = "steps/finestructure/"
os.makedirs(cp_dir+run_name, exist_ok=True)
idfile = "steps/finestructure/chr7_females.ids"
phasefile = "steps/finestructure/chr7_females.phase"
s3iters = 100000
s4iters = 50000
s1minsnps = 1000
s1indfrac = 0.1
...
def fs_start(cp_dir, run_name, idfile, phasefile,
    ...
    fs {run_name}.cp -hpc 1 -idfile ../../{idfile} -phasefiles ../../{phasefile} \
